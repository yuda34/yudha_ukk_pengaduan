...
<head>
    ...
    <link rel="shortcut icon" type="image/png/jpg" href="assets/img/logoapk.png">
</head>
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="<?= base_url('registrasi') ?>" method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="nama_lengkap" name="nama_lengkap" placeholder="NamaLengkap">
                                ...
                                <div class="text-center mt-5">
                                    Anda sudah mempunyai akun? <a class="small" href="<?= base_url('C_yuda_Auth') ?>">Silahkan Login!</a>
                                </div>
                            </form>
